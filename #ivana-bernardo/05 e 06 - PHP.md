...
<?php
    class Conta{
        ...
        public function sacar($valor){
            if ($valor <= $this->saldo){
                $this->saldo -= $valor;
                print_r('Saque realizado com sucesso!'); 
                echo "<br/>";
            } else {print_r('Saldo insuficiente!'); echo "<br/>";}
            return $valor;
        }
        ...
        public function transferir($valor, $recebedor){
            if ($valor > $this->saldo){
                print_r("Você não tem saldo suficiente para essa transferência");
                echo "<br/>";  
                return;
            }
            $this->sacar($valor);
    ...
    $conta1 = new contaCorrente(4539,'Ivana Bernardo',1000);
    $conta2 = new contaPoupanca(4852,'Ivana Bernardo', 500);
    print_r('Titular conta 1: ' . $conta1->getTitular());
    echo "<br/>";  
    print_r('Saldo conta 1: ' . $conta1->getSaldo());
    echo "<br/>";  
    print_r('Saldo conta 2: ' . $conta2->getSaldo()); 
    echo "<br/>";  
